...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg">Silahkan login sebagai <span class="text-info">Pasien</span> untuk
    ...
    <div class="text-center mt-3">Login Sebagai <a href="login.php"><span class="text-info">Dokter</span></a>
    </div>
    </div>
    <!-- /.login-box -->
