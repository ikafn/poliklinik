...
<body class="hold-transition login-page">
    <div class="container-fluid flex bg-info flex-col justify-center items-center text-white p-5"
        style="height: 300px;">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="loginUser.php" class="btn btn-info btn-block">Login Sebagai Pasien</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
